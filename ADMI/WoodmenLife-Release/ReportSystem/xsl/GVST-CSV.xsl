...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="reportExtractSet">
	 <xsl:text>"AGENT"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"CONTRACT"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"CONTRACT"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"CONTRACT"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"TERM"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"RETIRE"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"DECEASE"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"AGT"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"VESTING"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"VESTING"</xsl:text><xsl:text>,</xsl:text>
	    <xsl:text>"VESTING"</xsl:text><xsl:text>&#10;</xsl:text>
		...
		<xsl:text>"CD/RULE"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"DATE"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"MESSAGE"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>&#10;</xsl:text>
		<xsl:text>&#10;</xsl:text>
		<xsl:apply-templates select="com.lidp.model.admin.persistence.GVST__ReportMaster" />
	</xsl:template>
	<xsl:template match="com.lidp.model.admin.persistence.GVST__ReportMaster">
	
		<xsl:text>"</xsl:text><xsl:value-of select="agentName" /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"</xsl:text><xsl:value-of select="contractType" /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"</xsl:text><xsl:value-of select="contractNumber" /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"</xsl:text><xsl:value-of select="contractDate" /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"</xsl:text><xsl:value-of select="termDate" /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"</xsl:text><xsl:value-of select="retireDate" /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
		<xsl:text>"</xsl:text><xsl:value-of select="deceaseDate" /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
		
		<xsl:for-each select="./agtSit/string">
			<xsl:text>"</xsl:text><xsl:value-of select="." /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
			<xsl:text>"</xsl:text><xsl:value-of select="concat(../../vestingCd/char,'  ',../../vestingRule/string)" /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
			<xsl:text>"</xsl:text><xsl:value-of select="../../vestingDate/string" /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
			<xsl:text>"</xsl:text><xsl:value-of select="../../vestingMsg/string" /><xsl:text>"</xsl:text><xsl:text>&#10;</xsl:text>
  ...
  <xsl:template match="totals">
  	<xsl:text>&#10;</xsl:text>
  	<xsl:text>"TOTAL ENTRIES"</xsl:text><xsl:text>,</xsl:text>
  	<xsl:text>"</xsl:text><xsl:value-of select="numberOfEntries" /><xsl:text>"</xsl:text><xsl:text>,</xsl:text>
  </xsl:template>
</xsl:stylesheet>